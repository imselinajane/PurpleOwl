    ...
    <center>
        ...
        <form action="checkOut.do" method="POST">
            ...
            <div class="form-container">
                <div class="bookFull" id="bookFull">
            <div class="bookFullHeader2">
                <li>Booking is closed</li>
            </div>
            <br>
                <br>
                <br>
                We are fully booked today! <br>
                Please  contact us at social media pages for further announcements
            <br>
            <br>
            <br>
            <div class="transform">
              <a href="https://www.facebook.com/ThePurpleOwlTagaytay/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a href="https://www.instagram.com/thepurpleowltagaytay/?hl=en" ><i class="fa fa-instagram"  aria-hidden="true"></i></a>
                </div>
             <br>
                <br>
                <br>
            
            <div class="bookFullHeader3">
                <li>Booking is closed</li>
            </div>
            </div>
                <div class="form-navbar" id="form-navbar">
                ...
                <div class="form-content" id="form2">
                    ...
                    <div class="inputBox">
                        <textarea rows="5" cols="60" name="requestText" placeholder="Enter your requests/restrictions here" class="test"></textarea>
                        <div class="titleBox">
            ...
            <% int i = 0; %>
            <br><br><h1 id="price-header">Price: Php <span id="item-price">0.00</span></h1><br><br> <!-- change this css -->
...
<script>
    ...
    var isDisabled = <%=g_isDisabled%>;
    var maxBookingSlot = <%=maxBookingSlot%>;
    var totalBooking = <%=total%>;
        if(isDisabled) {
            document.getElementById("bookFull").style.display = "flex";
            document.getElementById("form1").style.display = "none";
            document.getElementById("form-navbar").style.display = "none";
            document.getElementById("item-price").style.display = "none";
            document.getElementById("price-header").style.display = "none";
        }
        
        else{
            document.getElementById("bookFull").style.display = "none";
            document.getElementById("form1").style.display = "flex";
            document.getElementById("form-navbar").style.display = "flex";
            document.getElementById("item-price").style.display = "contents";
            document.getElementById("price-header").style.display = "contents";
        }
        
        
        if(totalBooking >= maxBookingSlot) {
            document.getElementById("bookFull").style.display = "flex";
            document.getElementById("form1").style.display = "none";
            document.getElementById("form-navbar").style.display = "none";
            document.getElementById("item-price").style.display = "none";
